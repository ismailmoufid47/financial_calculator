...
class FinancialCalculatorApp:
    ...
    def create_future_value_tab(self):
        ...
        ttk.Label(self.future_value_tab, text="Principal:").grid(
        ...
        ttk.Label(self.future_value_tab, text="Annual Interest Rate (%):").grid(
            row=1, column=0, sticky="w"
        )
        self.future_value_rate_entry = ttk.Entry(self.future_value_tab)
        self.future_value_rate_entry.grid(row=1, column=1)

        ttk.Label(self.future_value_tab, text="Time (years):").grid(
        ...
        ttk.Button(
            self.future_value_tab, text="Calculate", command=self.calculate_future_value
    ...
    def calculate_future_value(self):
        ...
        rate = (
            float(self.future_value_rate_entry.get()) / 100
    ...
    def create_present_value_tab(self):
        ...
        ttk.Label(self.present_value_tab, text="Future Value:").grid(
            row=0, column=0, sticky="w"
        )
    ...
    def calculate_present_value(self):
        ...
        rate = (
            float(self.present_value_rate_entry.get()) / 100
        )  # Convert percentage to decimal
    ...
    def create_cagr_tab(self):
        ...
        ttk.Label(self.cagr_tab, text="Initial Principal:").grid(
            row=0, column=0, sticky="w"
        )
        ...
        ttk.Button(self.cagr_tab, text="Calculate", command=self.calculate_cagr).grid(
